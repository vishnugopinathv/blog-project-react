  ...
  return (
    <div className="home__container">
      <div className="home__head">
        ...
        <div className="hover__content">{article[0].title}<Link to={`/category/${article[0].category}/${article[0].id}`}><button>Read More</button></Link></div>
        </div>
        <div className="head__img__container">
        <img src={article[11].Image} alt="" />
        <div className="hover__content">{article[11].title}<Link to={`/category/${article[11].category}/${article[11].id}`}><button>Read More</button></Link></div>
        </div>
        <div className="head__img__container">
        <img src={article[21].Image} alt="" />
        <div className="hover__content">{article[21].title} <Link to={`/category/${article[21].category}/${article[21].id}`}><button>Read More</button></Link></div>
        </div>
      </div>
